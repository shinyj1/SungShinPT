...
module.exports = {
    ...
    addScheduleClear : async (req, res) => {
        try {
            ...
            let params = [scdl.scdlMemId, scdl.scdlPtId, scdl.isCovered, scdl.startTime, scdl.endTime, scdl.holiday, scdl.overPay, scdl.rest, scdl.night, scdl.extra, scdl.wage];
